...
while q.size() > 0:
    ...
    current_player_room = player.currentRoom.id
    # the next direction
    ...
    destination_room = player.currentRoom.id
    ...
    if destination_room not in room_map:
        ...
        room_map[destination_room] = {}

        # add the possible direction from the destination room to the
        # room map
        create_possible_direction(destination_room)
